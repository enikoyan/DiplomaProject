...
var changePasswordAPI = "https://localhost:44370/api/auth/changePassword";
...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    async function callChangePasswordAPI() {
        ...
        fetch(changePasswordAPI, requestOptions)
            ...
            .then(async data => {
                ...
                setTimeout(async () => {
                    location.href = 'https://localhost:44354/auth/login';
                }, 1000)
            })
            .catch(async error => {
    ...
    if (localStorage.getItem('serverKey') == null) {
        location.href = 'https://localhost:44354/auth/recoveryPassword/getRecoveryKey';
    }
});